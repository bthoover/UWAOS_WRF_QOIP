...
if __name__ == "__main__":
    ...
    # FIG Wa: 0-hr forecast most-intense simulation cross-section of perturbation temperature and 400-700 hPa mean
    ...
    latEnd = 48.75
    lonEnd = -142.5
    generate_cross_temperature_panel(unpHdl, ptdHdl, latBeg, lonBeg, latEnd, lonEnd, 'black', 'FIGW_panel_A')
    # FIG Wb: 6-hr forecast most-intense simulation cross-section of perturbation temperature and 400-700 hPa mean
    # temperature perturbation (along-shear)
    fcstHr = 6
    dtFcst = dtInit + datetime.timedelta(hours=fcstHr)
    dtFcstStr = datetime.datetime.strftime(dtFcst,'%Y-%m-%d_%H:00:00')
    ...
    latEnd = 45.5
    lonEnd = -135.0
    generate_cross_temperature_panel(unpHdl, ptdHdl, latBeg, lonBeg, latEnd, lonEnd, 'black', 'FIGW_panel_B')
    # FIG Wc: 12-hr forecast most-intense simulation cross-section of perturbation temperature and 400-700 hPa mean
    # temperature perturbation (along-shear)
    fcstHr = 12
    dtFcst = dtInit + datetime.timedelta(hours=fcstHr)
    dtFcstStr = datetime.datetime.strftime(dtFcst,'%Y-%m-%d_%H:00:00')
    ...
    latEnd = 46.0
    lonEnd = -132.0
    generate_cross_temperature_panel(unpHdl, ptdHdl, latBeg, lonBeg, latEnd, lonEnd, 'black', 'FIGW_panel_C')
    # FIG Wd: 18-hr forecast most-intense simulation cross-section of perturbation temperature and 400-700 hPa mean
    # temperature perturbation (along-shear)
    fcstHr = 18
    dtFcst = dtInit + datetime.timedelta(hours=fcstHr)
    dtFcstStr = datetime.datetime.strftime(dtFcst,'%Y-%m-%d_%H:00:00')
    ...
    latEnd = 43.5
    lonEnd = -128.0
    generate_cross_temperature_panel(unpHdl, ptdHdl, latBeg, lonBeg, latEnd, lonEnd, 'black', 'FIGW_panel_D')
#
# end
#
