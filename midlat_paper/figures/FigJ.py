...
if __name__ == "__main__":
    ...
    # FIG Jb: most-intense simulation cross-section of perturbation temperature and 400-700 hPa mean
    #         temperature perturbation (cross-shear)
    latBeg = 45.0
    lonBeg = -83.0
    latEnd = 25.0
    lonEnd = -88.0
    generate_cross_temperature_panel(unpHdl, ptdHdl, latBeg, lonBeg, latEnd, lonEnd, 'black', 'FIGJ_panel_B')
    # FIG Jc: most-intense simulation cross-section of perturbation wind speed and 400-700 hPa mean
    #         wind-speed perturbation (cross-shear)
    latBeg = 45.0
    lonBeg = -83.0
    latEnd = 25.0
    lonEnd = -94.0
    generate_cross_speed_panel(unpHdl, ptdHdl, latBeg, lonBeg, latEnd, lonEnd, 'black', 'FIGJ_panel_C')
#
# end
#
