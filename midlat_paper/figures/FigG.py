...
if __name__ == "__main__":
    ...
    plot_normalized_iterprofiles(ke, etaMidLev, 'KE', 'jet', 'FigG_panel_A')
    plot_normalized_iterprofiles(ape, etaMidLev, 'APE', 'jet', 'FigG_panel_B')
    plot_normalized_iterprofiles(qe, etaMidLev, 'QE', 'jet', 'FigG_panel_C')
    ...
    plt.savefig('FigG_panel_D.png', bbox_inches='tight', facecolor='white')
    #
    # end
    #
