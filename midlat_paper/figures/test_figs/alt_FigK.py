...
def right_panel(ax, payloadTuple):
    # expand payloadTuple into lat/lon cross section bounds, unpHdl and ptdHdl, and interpolation level
...
def generate_figure_panel(unpHdl, ptdHdl, latBeg, lonBeg, latEnd, lonEnd, figureName):
    ...
    fig, latLists, lonLists = cross_section_plot(
                                 ...
                                 datProj=datProj,
                                 plotProj=plotProj,
                                 planSectPlotTuple=(right_panel, (21.0, 261.5, 55.0, 297.5, unpHdl, ptdHdl, 55000.)),
                                 presLevMin=10000.,
                                 xSectTitleStr=None,
