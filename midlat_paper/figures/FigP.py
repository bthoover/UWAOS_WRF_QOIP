...
if __name__ == "__main__":
    ...
    plot_normalized_iterprofiles(ke, etaMidLev, 'KE', 'jet', 'FigP_panel_A')
    plot_normalized_iterprofiles(ape, etaMidLev, 'APE', 'jet', 'FigP_panel_B')
    plot_normalized_iterprofiles(qe, etaMidLev, 'QE', 'jet', 'FigP_panel_C')
    ...
    plt.savefig('FigP_panel_D.png', bbox_inches='tight', facecolor='white')
    #
    # end
    #
