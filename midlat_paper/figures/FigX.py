# Figure X: Cross-section of perturbation PV, with plan-section perturbation 400 hPa PV and omega
...
def generate_figure_panel(unpHdl, ptdHdl, latBeg, lonBeg, latEnd, lonEnd, figureName):
    ...
    fig, latLists, lonLists = cross_section_plot(
                                 ...
                                 datProj=datProj,
                                 plotProj=plotProj,
                                 planSectPlotTuple=(right_panel, (unpHdl, ptdHdl, 40000.)),
                                 presLevMin=10000.,
                                 xSectTitleStr=None,
...
if __name__ == "__main__":
    ...
    # FIG Xd: most-intense simulation 6-hr cross section of perturbation PV
    fcstHr = 9
    dtFcst = dtInit + datetime.timedelta(hours=fcstHr)
    dtFcstStr = datetime.datetime.strftime(dtFcst,'%Y-%m-%d_%H:00:00')
    unpFileFcst = unpDir + 'wrfout_d01_' + dtFcstStr
