# Figure Q
# a) normalized initial condition perturbation kinetic energy (u', v') profiles on each iteration of most-intense simulation
# b) normalized initial condition perturbation available potential (t') energy profiles on each iteration of most-intense simulation
# c) normalized initial condition perturbation latent (q') energy profiles on each iteration of most-intense simulation
# d) total-column initial condition perturbation energy of each type (KE, APE, QE) on each iteration of most-intense simulation
import numpy as np
...
if __name__ == "__main__":
    ...
    plot_normalized_iterprofiles(ke, etaMidLev, 'KE', 'jet', 'FigQ_panel_A')
    plot_normalized_iterprofiles(ape, etaMidLev, 'APE', 'jet', 'FigQ_panel_B')
    plot_normalized_iterprofiles(qe, etaMidLev, 'QE', 'jet', 'FigQ_panel_C')
    ...
    plt.savefig('FigQ_panel_D.png', bbox_inches='tight', facecolor='white')
    #
    # end
    #
